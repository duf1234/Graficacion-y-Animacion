...
return [
    ...
    'checksum' => 'a5806f25523fbd8b6f3c7a34f8bffca3',
    'files' => [
...
',
            ...
            'plugins.adsense.data' => [
                'type' => 'fieldset',
                'collapsed' => true,
                'icon' => 'key',
                'name' => 'plugins.adsense.data',
                'validation' => 'strict'
            ],
            ...
            'plugins.presentation.defaults' => [
                'type' => 'tab',
                'name' => 'plugins.presentation.defaults',
                'validation' => 'strict'
            ],
            ...
            'plugins.presentation.advanced' => [
                'type' => 'tab',
                'name' => 'plugins.presentation.advanced',
                'validation' => 'strict'
            ],
            'plugins.presentation.tabs' => [
                'type' => 'tabs',
                'active' => 1,
                'name' => 'plugins.presentation.tabs',
                'validation' => 'strict'
            ],
            'plugins.archives' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'presentation' => [
                    'tabs' => 'plugins.presentation.tabs',
                    ...
                    'defaults' => 'plugins.presentation.defaults',
                    'textsize' => [
                    ...
                    'advanced' => 'plugins.presentation.advanced',
