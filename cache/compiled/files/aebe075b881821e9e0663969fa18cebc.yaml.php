...
return [
    ...
    'filename' => '/var/www/html/grav/user/themes/gravi-k/blueprints/default.yaml',
    'modified' => 1560743129,
    'data' => [
                        ...
                        'content' => [
                            ...
                            'fields' => [
                                ...
                                'display1' => [
                                    'type' => 'display',
                                    'label' => 'instructions',
                                    'content' => 'It is possible to position an image to right or to left. For this you must enable the option "Markdown extra" in the site configuration. Then use the instructions "{.fl} " or "{.fr}" placed after the insertion of the image. Example: "![my-image](image.jpg){.fl}" for the left and "![my-image](image.jpg){.fr}" for the right.'
                                ]
                            ]
                        ],
                        'options' => [
