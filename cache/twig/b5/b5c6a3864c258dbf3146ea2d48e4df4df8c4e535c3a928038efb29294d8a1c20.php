...
class __TwigTemplate_a23694d8a98130ecb301a6f8cb1e79c090bc91bf511e8e94fa7a8bbb925fabe0 extends \Twig\Template
{
...
";
        ...
        if (($context["taxlist"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["tax"] => $context["value"]) {
                ...
                // line 7
                echo "                    <a class=\"btn btn-outline-primary btn-sm mb-1 ";
...
";
    ...
    {
        return array (  66 => 10,  52 => 8,  47 => 7,  44 => 6,  40 => 5,  37 => 4,  35 => 3,  32 => 2,  30 => 1,);
    }
        ...
        <div class=\"d-inline-block\">
            {% for tax,value in taxlist[taxonomy] %}
                {% set active = uri.param(taxonomy) == tax? 'active' : '' %}
                    <a class=\"btn btn-outline-primary btn-sm mb-1 {{ active }}\"
                       href=\"{{ base_url }}/{{ taxonomy }}{{ config.system.param_sep }}{{ tax }}\">{{ tax }}</a>
            {% endfor %}
        </div>
{% endif %}
", "partials/taxonomylist.html.twig", "/var/www/html/grav/user/themes/bootstrap-blog/templates/partials/taxonomylist.html.twig");
    }
}
